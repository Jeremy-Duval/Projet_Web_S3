...
--
-- Client :  localhost
-- Généré le :  Mer 02 Novembre 2016 à 17:55
...
INSERT INTO `Comments` (`CommentID`, `MovieID`, `Login`, `Comment`) VALUES
(6, 1, 'iut', 'first'),
(7, 1, 'iut', 'yo !'),
(8, 12, 'iut', 'hey !'),
(9, 12, 'iut', 'first'),
(10, 12, 'iut', 'fgfdhdfh'),
(11, 2, 'iut', 'Ceci est un commentaire !'),
(12, 1, 'iut', '2016'),
(13, 1, 'iut', 'efs'),
(14, 1, 'iut', 'efs');
...
INSERT INTO `Utilisateur` (`UserID`, `Login`, `Pass`, `Nom`, `Mail`, `image`) VALUES
(1, 'iut', 'iut2016', 'genuini', 'genuini@arduino.com', 0),
(3, 'b', 'b', 'b', 'b', 1),
(4, 'c', 'c', 'c', 'c', 0),
(5, 'a', 'a', 'a', 'a', 1);
...
ALTER TABLE `Comments`
  ADD PRIMARY KEY (`CommentID`,`MovieID`),
  ADD KEY `fk_MovieID_Comment` (`MovieID`);
...
--
ALTER TABLE `Comments`
  MODIFY `CommentID` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `Comments`
  ADD CONSTRAINT `fk_MovieID_Comment` FOREIGN KEY (`MovieID`) REFERENCES `Movie` (`MovieID`);
